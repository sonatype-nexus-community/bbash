...
- `go get -u github.com/cosmtrek/air` in a folder outside this project (so it is not added as a dependency).
  ...
  The [AIRCMD](https://github.com/sonatype-nexus-community/bbash/blob/main/Makefile#L5) setting in the Makefile may need to be adjusted if a different location is used. 
